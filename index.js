...
const loadInitialCardData = () => {
    ...
    cards.map((cardObject) => {
        taskContainer.insertAdjacentHTML("beforeend", generatNewCard(cardObject));
...
taskContainer.insertAdjacentHTML("beforeend", generatNewCard(taskData));
